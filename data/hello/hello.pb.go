...
type Hello struct {
	...
	Myhost               string   `protobuf:"bytes,5,opt,name=myhost,proto3" json:"myhost,omitempty"`
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x73, 0x94, 0x4a, 0xb9, 0x20, 0x0c,
	...
	0x36, 0xc8, 0xd4, 0xdc, 0xca, 0x8c, 0xfc, 0xe2, 0x12, 0x09, 0x56, 0xb0, 0x28, 0x94, 0xe7, 0x24,
	0x70, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0xce, 0x78, 0x2c,
	0xc7, 0x90, 0xc4, 0x06, 0x76, 0x96, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x68, 0xad, 0x59, 0x82,
	0xa5, 0x00, 0x00, 0x00,
}
...
func (m *Hello) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Myhost) > 0 {
		i -= len(m.Myhost)
		copy(dAtA[i:], m.Myhost)
		i = encodeVarintHello(dAtA, i, uint64(len(m.Myhost)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Name) > 0 {
...
func (m *Hello) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Myhost", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Myhost = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
